...
export const exploreResults: Record<ExploreCategory, ExploreResult[]> = {
  ...
  events: [
    {
      ...
      summary: "Encontro social fictício com música e recepção para novos participantes.",
      meta: "Sábado · 21h",
      initials: "NC",
      verified: true,
  ...
  professionals: [
    ...
    },
    {
      ...
      summary: "Criador independente com portfólio e contato ainda não disponíveis.",
      meta: "Perfil de demonstração",
      initials: "AL",
      verified: false,
    },
